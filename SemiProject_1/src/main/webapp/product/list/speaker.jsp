...
<!-- Start Content -->
	...
	<div class="banner-wrap">
		<div class="banner-img">
			<img src="https://resource.logitech.com/w_1800,h_1800,c_limit,q_auto,f_auto,dpr_2.0/d_transparent.gif/content/dam/logitech/en/plp/speakers/computer-speakers/computer-speakers-plp-header-desktop.jpg?v=1">	
		</div>
		<div class="banner-text">
			<b class="b1">컴퓨터 스피커</b>
			<p>2.1 시스템, 컴팩트 북셸프형 스피커, 스테레오 스피커, 데스크톱 스피커,<br>서브우퍼 탑재 스피커 시스템을 포함한 컴퓨터 스피커를 구매해보세요.</p>
		</div>
	</div>
            ...
            <div class="col-lg-3">
                ...
                <div class="row" style="padding:5px 20px 5px 10px; align-items: center;">
					...
					<div class="collectionblock titleblock row pb-2" style="cursor: pointer;">
						<div class="col">
							<span class="collapse show pl-3"><strong>스피커 유형</strong></span>
						</div>
					...
					<div id="collectioncon" style="margin-left: 20px;">
						<p><label for="stereo" style="cursor: pointer;"><input type="checkbox" class="filters" id="stereo" value="스테레오" onchange="makeFilter(this);">&nbsp;&nbsp;스테레오 스피커</label></p>
					</div>
					<hr style="width: 95%;">
					...
					<div id="connectioncon" style="margin-left: 20px;">
						<p><label for="3.5" style="cursor: pointer;"><input type="checkbox" class="filters" id="3.5" value="3.5mm" onchange="makeFilter(this);">&nbsp;&nbsp;3.5mm 입력 단자</label></p>
						<p><label for="usb" style="cursor: pointer;"><input type="checkbox" class="filters" id="usb" value="usb" onchange="makeFilter(this);">&nbsp;&nbsp;USB 입력</label></p>
						...
						<p><label for="jack" style="cursor: pointer;"><input type="checkbox" class="filters" id="jack" value="jack" onchange="makeFilter(this);">&nbsp;&nbsp;헤드폰 잭</label></p>
					</div>
					<hr style="width: 95%;">
				</div>
            </div>
            ...
            <div class="col-lg-9">
                ...
                <%
                	for(ProductDto dto:list) {
                		...
                		if(dto.getCategory().equals("컴퓨터 스피커") || dto.getCategory().equals("Logi Dock")) {
                	%>
