...
<!-- Start Content -->
	...
	<div class="banner-wrap">
		<div class="banner-img">
			<img src="https://resource.logitech.com/w_1800,h_1800,c_limit,q_auto,f_auto,dpr_2.0/d_transparent.gif/content/dam/logitech/en/plp/speakers/bluetooth-speakers/bluetooth-speakers-plp-header-desktop-2.jpg?v=1">	
		</div>
		<div class="banner-text">
			<b class="b1">BLUETOOTH 스피커</b>
			<p>5.1 서라운드 사운드 시스템, 스테레오 컴퓨터 스피커, 서브우퍼 탑재 2.1<br>시스템을 포함한 Bluetooth® 스피커를 구매해보세요.</p>
		</div>
	</div>
            ...
            <div class="col-lg-9">
                ...
                <%
                	for(ProductDto dto:list) {
                		...
                		if(dto.getCategory().equals("Bluetooth 스피커") || dto.getCategory().equals("Logi Dock")) {
                	%>
