...
<!-- Start Content -->
	...
	<div class="banner-wrap">
		<div class="banner-img">
			<img src="https://resource.logitech.com/w_1800,h_1800,c_limit,q_auto,f_auto,dpr_2.0/d_transparent.gif/content/dam/logitech/en/plp/room-solutions/room-solutions-hero-desktop-2.png?v=1">	
		</div>
		<div class="banner-text">
			<b class="b1">화상 회의실 솔루션</b>
			<p>모든 크기의 회의실에서 간편하게 사용할 수 있으며<br>다양한 소프트웨어 플랫폼과 호환되는 고품질 회의 솔루션.</p>
		</div>
	</div>
            ...
            <div class="col-lg-8" style="width: 100% !important;">
                ...
                <%
                	for(ProductDto dto:list) {
                		...
                		if(dto.getCategory().equals("통합 회의실 솔루션")) {
                	%>
