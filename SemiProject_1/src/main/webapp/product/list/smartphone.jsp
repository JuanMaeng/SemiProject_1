...
<!-- Start Content -->
	...
	<div class="banner-wrap">
		<div class="banner-img">
			<img src="https://resource.logitech.com/w_1800,h_1800,c_limit,q_auto,f_auto,dpr_2.0/d_transparent.gif/content/dam/logitech/en/plp/smartphone-accessories/smartphone-hero-desktop.png?v=1">	
		</div>
		<div class="banner-text">
			<b class="b1">스마트폰 액세서리</b>
			<p>휴대폰 액세서리를 확인해보세요.</p>
		</div>
	</div>
            ...
            <div class="col-lg-8" style="width: 100% !important;">
                ...
                <%
                	for(ProductDto dto:list) {
                		...
                		if(dto.getCategory().equals("스마트폰용")) {
                	%>
